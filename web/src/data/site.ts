...
// VERSION traces to the workspace Cargo.toml (`version = "8.0.1"`); the SDK
...
// SDK install coordinates — all four ship the same 8.0.1 release surface.
export const SDKS = [
  {
    id: 'rust',
    name: 'Rust CLI + SDK',
  ...
  },
  {
    ...
    install: 'npm install @goliapkg/smix@8.0.1',
    lang: 'bash',
  },
  {
    id: 'kotlin',
    ...
    install: 'implementation("jp.golia.smix:smix-sdk:8.0.1")',
    lang: 'kotlin',
  },
  {
    id: 'swift',
    ...
    registry: 'SwiftPM',
    coordinate: 'goliajp/smix @ swift-v8.0.1',
    install: '.package(url: "https://github.com/goliajp/smix", from: "8.0.1")',
    lang: 'swift',
  },
] as const
