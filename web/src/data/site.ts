...
// VERSION traces to the workspace Cargo.toml (`version = "6.3.0"`); the SDK
...
// SDK install coordinates — all four ship the same 6.3.0 release surface.
export const SDKS = [
  {
    id: 'rust',
    name: 'Rust CLI + SDK',
  ...
  },
  {
    ...
    install: 'npm install @goliapkg/smix@6.3.0',
    lang: 'bash',
  },
  {
    id: 'kotlin',
    ...
    install: 'implementation("jp.golia.smix:smix-sdk:6.3.0")',
    lang: 'kotlin',
  },
  {
    id: 'swift',
    ...
    registry: 'SwiftPM',
    coordinate: 'goliajp/smix @ swift-v6.3.0',
    install: '.package(url: "https://github.com/goliajp/smix", from: "6.3.0")',
    lang: 'swift',
  },
] as const
