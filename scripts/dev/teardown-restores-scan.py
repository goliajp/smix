...
SHUTS_DOWN_SCRIPTS = {
    ...
    "v11.0-c1-a-press-that-lands-e2e.sh",
    "v11.0-c3-one-control-two-names-e2e.sh",
    "v11.0-c7-a-control-that-moved-e2e.sh",
    "v11.0-c8-something-appeared-between-e2e.sh",
    "v11.0-c9b-back-in-gesture-navigation-e2e.sh",
    "v11.0-c9b-ios-gestures-and-alert-e2e.sh",
    "v11.0-c9c-two-runners-one-checkout-e2e.sh",
    "v11.0-c9e-an-empty-field-holds-nothing-e2e.sh",
    "v11.0-c9f-hardware-keys-e2e.sh",
    ...
    "v6.2-c3-capability-parity-e2e.sh",
    "v6.2-c4-env-interpolation-e2e.sh",
    "v6.2-c5-tree-text-e2e.sh",
