...
SHUTS_DOWN_SCRIPTS = {
    ...
    "v11.1-c7-a-control-that-moved-e2e.sh",
    "v11.1-c8-something-appeared-between-e2e.sh",
    ...
    "v11.1-c9f-hardware-keys-e2e.sh",
    "v11.1-c9h-focus-after-enter-e2e.sh",
    "v11.1-c9h-keyboard-minimized-e2e.sh",
    "v11.1-c9i-keyboard-beside-the-probe-e2e.sh",
    "smoke-chain-e2e.sh",
    ...
    "v11.1-c9k-an-emulator-quits-cleanly-e2e.sh",
