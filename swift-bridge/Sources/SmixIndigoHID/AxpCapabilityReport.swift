...
/// Wire-stable JSON report emitted by `smix-host-hid axp-probe`.
///
...
public struct AxpCapabilityReport: Equatable {
  ...
  public func json() -> String {
    ...
    let frameworkJson =
      "{\"path\":\"\(SmixHostJsonEscape.escape(framework.path))\"," +
  ...
  /// TS `smix doctor` side can render it deterministically.
