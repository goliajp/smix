...
| # | 承诺 | 状态 | 判据 | 依据 | 核验日 |
|---|---|---|---|---|---|
| 1 | 围栏式 AI 断言层(`assertCondition` / `extractWithAI`,opt-in,firewall 在 sense 之外) | shipped | `at crates/smix-adapter-maestro/src/parser.rs:1600 "assertCondition"` | 独立 crate `smix-ai-tier` + parser 认这两个 verb;删该 crate 不动任何 sensing 代码,即其 fence 的证明 | 2026-07-22 |
