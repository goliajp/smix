...
| 3a | MCP 驱动面:fill / swipe / scroll / launch / stop / assert 六类 | shipped | `at crates/smix-mcp/src/main.rs:506 "open_session_in_place"` | 13 个 tool 覆盖这六类,各映射已有 `App::` 方法 | 2026-07-22 |
